...
const MainContent = () => {
    ...
    const {searchQuery, selectedCategories ,minPrice, maxPrice, keyword} = useFilter();
    ...
    const getFilteredProducts = ()=>{
        ...
        if (selectedCategories) {
            filteredProducts = filteredProducts.filter(product => product.category === selectedCategories);
  ...
  return (
    <section className="xl:w-[55rem] mr-[5rem] lg:w-[55rem] sm:w-[40rem] xs:w-[20rem] p-5 ">
